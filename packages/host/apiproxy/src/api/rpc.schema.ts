...
export const rpcErrorSchema: z.ZodType<RpcError> = z.discriminatedUnion('code', [
  ...
  z.object({ code: z.literal('workspace-files-denied'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('workspace-files-not-found'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('workspace-files-not-text'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('workspace-files-too-large'), message: z.string(), details: z.object({ path: z.string() }) }),
  z.object({ code: z.literal('workspace-files-unreadable'), message: z.string(), details: z.object({ path: z.string() }) }),
